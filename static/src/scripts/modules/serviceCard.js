class ServiceCard {
    constructor(id) {
        ...
        this.buttons = this.serviceList.querySelectorAll('button.services__btn-btn')
        this.cardContainer = this.serviceList.querySelector('.service-listings__inner')
    ...
    events() {
        ...
        this.buttons.forEach(btn => btn.addEventListener('click',this.handleBtnClick.bind(this)))
    ...
    addActiveToCard(cardID) {
        this.cards.forEach(card => {
            ...
            card.dataset.id === cardID ? card.setAttribute('aria-expanded', true): card.setAttribute('aria-expanded', false)
